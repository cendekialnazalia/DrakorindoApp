...
class DrakorindoRepository private constructor(
    ...
    companion object {
        @Volatile
        private var instance: DrakorindoRepository? = null

        fun getInstance(
            remoteData: RemoteDataSource,
            localData: LocalDataSource,
            appExecutors: AppExecutors
        ): DrakorindoRepository =
            instance ?: synchronized(this) {
                instance ?: DrakorindoRepository(remoteData, localData, appExecutors).apply {
                    instance = this
                }
            }
    }
